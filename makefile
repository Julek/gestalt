...
kernel.o : kernel.c
	i586-elf-gcc -o kernel.o -c kernel.c -Wall -Wextra -Werror -nostdlib -nostartfiles -nodefaultlibs -std=c99 -fstack-protector-all -I ./include
...
isr.o : ./libs/isr.c
	i586-elf-gcc -o isr.o -c ./libs/isr.c -Wall -Wextra -Werror -nostdlib -nostartfiles -nodefaultlibs -std=c99 -fstack-protector-all -I ./include
...
kernel.bin : loader.o kernel.o stdio.o system.o gdt.o paging.o idt.o isr.o isr_a.o system_a.o stack_protector.o
	i586-elf-ld -T linker.ld -o kernel.bin loader.o kernel.o stdio.o system.o gdt.o paging.o idt.o isr.o isr_a.o system_a.o stack_protector.o
